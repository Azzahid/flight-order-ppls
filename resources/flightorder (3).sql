...
--
-- Dumping data for table `bookingpassenger`
--

INSERT INTO `bookingpassenger` (`Id`, `BookingId`, `PassengerId`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 2),
(4, 1, 1),
...
INSERT INTO `bookings` (`Id`, `UserId`, `FlightId`, `Status`, `TotalPrice`, `PaymentMethod`, `BookingTime`) VALUES
(1, 1, 1, 'Lunas', 0, 'Kredit', '2017-11-16 00:00:00'),
(2, 1, 2, 'Pending', 0, 'Transfer', '2017-11-17 00:00:00');
...
INSERT INTO `passenger` (`Id`, `UserId`, `PassengerName`, `IdUsed`, `IdNumber`) VALUES
(1, 1, 'Azzahid Adhitya', 'KTP', '12341211123412523'),
(2, 1, 'Ade Surya', 'KTP', '1234111661251231');
...
(1, 'zahid', 'Ferdie Carnock', 'bismillah', '43ec4ef6-db3c-4110-ad17-7d59019376a0', '2017-11-15 22:09:14'),
...
--
-- Indexes for table `bookingpassenger`
--
...
--
-- AUTO_INCREMENT for table `bookingpassenger`
--
ALTER TABLE `bookingpassenger`
...
--
-- Constraints for table `bookingpassenger`
--
ALTER TABLE `bookingpassenger`
  ADD CONSTRAINT `bookingpassenger_ibfk_1` FOREIGN KEY (`BookingId`) REFERENCES `bookings` (`Id`),
  ADD CONSTRAINT `bookingpassenger_ibfk_2` FOREIGN KEY (`PassengerId`) REFERENCES `passenger` (`Id`);
...
--
ALTER TABLE `passenger`
  ADD CONSTRAINT `passenger_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `users` (`Id`);
COMMIT;
